...
const defaultColors: { value: string }[] = [
  {
...
export function ColorPicker(props: { onChange: (color: string) => void, value: string, colors: { value: string }[] }) {

  return <div className="color-picker">
    {(props.colors ?? defaultColors).map(({ value }) => <div
